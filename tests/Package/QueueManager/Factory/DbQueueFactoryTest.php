...
class DbQueueFactoryTest extends TestCase
{
    public function testCreateFromConfig()
    {
        $queues = DbQueueFactory::createFromConfig([
            'db' => [
                'dsn' => 'sqlite::memory:',
            ],
            'name' => [
        ...
        $retryTimeProperty = new ReflectionProperty(DbQueue::class, 'retryTime');
        $maxAttemptsProperty = new ReflectionProperty(DbQueue::class, 'maxAttempts');
